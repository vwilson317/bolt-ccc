...
('qa-premium', 'QA Premium Store', '001', 'Ipanema', 
 ...
 false,
 '[{"id": "qa-test-btn", "text": "QA Test", "action": {"type": "url", "value": "https://qa-test.com"}, "style": "primary", "position": 1, "visibilityConditions": {}, "enabled": true}]',
