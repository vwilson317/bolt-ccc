/*
  # Weather Cache System Implementation
  ...
  2. Security
    ...
    - Add policy for public read access to weather data
    - Add policy for authenticated users to manage weather cache

  3. Functions
    - `get_weather_for_location()` - Get cached weather for a location
  ...
  4. Performance
    - Indexes on location and expiration time for fast lookups
*/
