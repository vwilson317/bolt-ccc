...
export default {
  content: ['./index.html', './src/**/*.{js,ts,jsx,tsx}', '!./src/_deprecated/**'],
  theme: {
    extend: {
      colors: {
        ...
        // FLOW. community project (/projects/flow) — "Emerald Flow" design tokens.
        // Namespaced under `flow` so it can never collide with the main site palette.
        'flow': {
          surface: '#f7f9ff',
          'surface-dim': '#d4dbe4',
          ...
          primary: '#006c52',
          'on-primary': '#ffffff',
          'primary-container': '#20b28b',
          'on-primary-container': '#003d2d',
          'inverse-primary': '#5adcb2',
          secondary: '#5c5f61',
          'on-secondary': '#ffffff',
      ...
      fontFamily: {
        ...
        // FLOW. community project fonts
        'flow-headline': ['"Plus Jakarta Sans"', 'ui-sans-serif', 'system-ui', 'sans-serif'],
        'flow-body': ['"Hanken Grotesk"', 'ui-sans-serif', 'system-ui', 'sans-serif'],
        'flow-icons': ['"Material Symbols Outlined"'],
      },
    },
  },
  safelist: [
