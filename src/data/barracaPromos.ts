...
export const BARRACA_PROMOS: BarracaPromoConfig[] = [
  ...
  },
  {
    ...
    slug: 'jota86',
    name: "Jota's Tent",
    instagramHandle: 'barracadojota86',
    instagramUrl: 'https://instagram.com/barracadojota86',
    discountCode: 'JOTA86',
    barracaLocation: 'Rio de Janeiro',
    whatsappUrl: CCC_WHATSAPP_URL,
    logoPath: '/jota86-logo.PNG',
    badgeFromColor: 'purple-500',
    badgeToColor: 'violet-600',
    passBackgroundRgb: 'rgb(168,85,247)',
    active: true,
    storageKey: 'ccc_badge_jota86-follow',
    identifierStorageKey: 'ccc_identifier_jota86-follow',
  },
  {
    id: 'hulk202-follow',
    slug: 'hulk202',
