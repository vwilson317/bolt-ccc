/*
  # Restore get_barracas_with_open_status RPC for PostgREST

  Ensures the RPC exists with a single canonical signature,
  uses generic open-status logic (07:00-18:00 local time),
  and is executable by API roles.
*/

DROP FUNCTION IF EXISTS get_barracas_with_open_status(
  INTEGER,
  INTEGER,
  TEXT,
  TEXT,
