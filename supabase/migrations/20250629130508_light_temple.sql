/*
  # Update Hours Schema to UTC with Open/Close Columns

  1. Schema Changes
    - Replace typical_hours text field with separate open_time and close_time
    - Add timezone field for proper UTC conversion
    - Add day_of_week specific hours support
    - Maintain backward compatibility

  2. Data Migration
    - Convert existing typical_hours to new format
    - Set default timezone to America/Sao_Paulo (Rio timezone)
    - Parse existing hours and populate new columns

  3. Enhanced Features
    - Support for different hours per day of week
...
-- Enable real-time subscriptions for business hours
...
('5', 0, true, convert_local_to_utc('16:00'::time), convert_local_to_utc('02:00'::time), 'Sunday - Late night'),
('5', 1, false, NULL, NULL, 'Closed on Mondays'),
('5', 2, true, convert_local_to_utc('16:00'::time), convert_local_to_utc('01:00'::time), 'Tuesday - Late night'),
('5', 3, true, convert_local_to_utc('16:00'::time), convert_local_to_utc('01:00'::time), 'Wednesday - Late night'),
('5', 4, true, convert_local_to_utc('16:00'::time), convert_local_to_utc('02:00'::time), 'Thursday - Late night'),
('5', 5, true, convert_local_to_utc('16:00'::time), convert_local_to_utc('03:00'::time), 'Friday - Very late'),
('5', 6, true, convert_local_to_utc('16:00'::time), convert_local_to_utc('03:00'::time), 'Saturday - Very late'),

-- Praia Zen - Early morning hours with lunch break
('4', 0, true, convert_local_to_utc('07:00'::time), convert_local_to_utc('17:00'::time), 'Sunday - Wellness day'),
...
('4', 6, true, convert_local_to_utc('07:00'::time), convert_local_to_utc('17:00'::time), 'Saturday - Weekend hours');
