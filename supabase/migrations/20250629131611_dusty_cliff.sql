/*
  ...
  1. Environments
    - `dev` - Development with full dataset and debug features
    - `qa` - Quality Assurance with subset data for testing  
    - `uat` - User Acceptance Testing with minimal data
    - `prod` - Production with live data and security restrictions

  2. Schema Structure
    - Identical table structures across all environments
    - Environment-specific functions, triggers, and RLS policies
    - Appropriate data seeding per environment

  3. Security
    - Row Level Security enabled on all tables
    - Environment-appropriate access controls
...
BEGIN
  ...
  -- Add sample business hours for some barracas
  IF barraca_count >= 1 THEN
    -- Add business hours for Barraca Uruguay
    EXECUTE format('
    ...
    USING 
      ...
      'barraca-uruguay', 1, true, '12:00'::time, '22:00'::time, 'Monday - Regular hours',
      'barraca-uruguay', 6, true, '12:00'::time, '23:00'::time, 'Saturday - Extended hours';
  END IF;
